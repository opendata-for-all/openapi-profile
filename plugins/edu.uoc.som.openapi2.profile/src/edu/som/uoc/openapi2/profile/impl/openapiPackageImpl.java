...
public class openapiPackageImpl extends EPackageImpl implements openapiPackage {
	 ...
	 */
	@Override
	public EAttribute getAPIProperty_Required() {
	 ...
	 */
	@Override
	public EAttribute getAPIProperty_Example() {
		return (EAttribute)apiPropertyEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getAPIProperty_Description() {
		return (EAttribute)apiPropertyEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(apiPropertyEClass, API_PROPERTY__REQUIRED);
	...
	public void initializePackageContents() {
		...
		initEClass(apiEClass, edu.som.uoc.openapi2.profile.API.class, "API", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAPI_Host(), theTypesPackage.getString(), "host", null, 1, 1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAPI_BasePath(), theTypesPackage.getString(), "basePath", null, 1, 1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAPI_Schemes(), this.getSchemeType(), "schemes", null, 0, -1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAPI_Consumes(), theTypesPackage.getString(), "consumes", null, 0, -1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getAPI_Produces(), theTypesPackage.getString(), "produces", null, 0, -1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAPI_Base_Model(), theUMLPackage.getModel(), null, "base_Model", null, 0, 1, edu.som.uoc.openapi2.profile.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getAPIParameter_Required(), this.getBoolean(), "required", null, 0, 1, APIParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getAPIProperty_Required(), this.getBoolean(), "required", null, 0, 1, APIProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getAPIProperty_Base_Property(), theUMLPackage.getProperty(), null, "base_Property", null, 1, 1, APIProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
