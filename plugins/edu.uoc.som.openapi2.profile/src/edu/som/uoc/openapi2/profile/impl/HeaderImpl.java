 ...
 * </p>
 * <ul>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getCollectionFormat <em>Collection Format</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getMultipleOf <em>Multiple Of</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.HeaderImpl#getEnum <em>Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
