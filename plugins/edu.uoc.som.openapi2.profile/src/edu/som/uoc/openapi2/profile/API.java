 ...
 * </p>
 * <ul>
 *   <li>{@link edu.som.uoc.openapi2.profile.API#getHost <em>Host</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.API#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.API#getSchemes <em>Schemes</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.API#getConsumes <em>Consumes</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.API#getProduces <em>Produces</em>}</li>
...
public interface API extends EObject {
	...
	/**
	 * Sets the value of the '{@link edu.som.uoc.openapi2.profile.API#getHost <em>Host</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link edu.som.uoc.openapi2.profile.API#getBasePath <em>Base Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link edu.som.uoc.openapi2.profile.API#getBase_Model <em>Base Model</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
