 ...
 * </p>
 * <ul>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.RequiredSecuritySchemeImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.som.uoc.openapi2.profile.impl.RequiredSecuritySchemeImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredSecuritySchemeImpl extends MinimalEObjectImpl.Container implements RequiredSecurityScheme {
	...
	protected EClass eStaticClass() {
		return OpenAPIProfilePackage.Literals.REQUIRED_SECURITY_SCHEME;
	}
	...
	public EList<String> getScopes() {
		if (scopes == null) {
			scopes = new EDataTypeUniqueEList<String>(String.class, this, OpenAPIProfilePackage.REQUIRED_SECURITY_SCHEME__SCOPES);
		}
		return scopes;
	}
