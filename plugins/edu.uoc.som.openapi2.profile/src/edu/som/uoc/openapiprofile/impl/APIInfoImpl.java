 ...
 *   <li>{@link edu.som.uoc.openapiprofile.impl.APIInfoImpl#getLicense <em>License</em>}</li>
 *   <li>{@link edu.som.uoc.openapiprofile.impl.APIInfoImpl#getContact <em>Contact</em>}</li>
