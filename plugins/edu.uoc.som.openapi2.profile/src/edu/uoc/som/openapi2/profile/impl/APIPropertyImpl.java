 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.profile.impl.APIPropertyImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.profile.impl.APIPropertyImpl#getBase_Property <em>Base Property</em>}</li>
 *   <li>{@link edu.uoc.som.openapi2.profile.impl.APIPropertyImpl#getXml <em>Xml</em>}</li>
 ...
 *   <li>{@link edu.uoc.som.openapi2.profile.impl.APIPropertyImpl#getIsID <em>Is ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APIPropertyImpl extends JSONSchemaSubsetImpl implements APIProperty {
	...
	public void setIsID(Boolean newIsID) {
		...
		isID = newIsID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenAPIProfilePackage.API_PROPERTY__IS_ID, oldIsID, isID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OpenAPIProfilePackage.API_PROPERTY__TITLE:
				return getTitle();
			case OpenAPIProfilePackage.API_PROPERTY__IS_ID:
				return getIsID();
		}
