 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.openapi2.profile.impl.SecurityRequirementImpl#getSecuritySchemes <em>Security Schemes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecurityRequirementImpl extends MinimalEObjectImpl.Container implements SecurityRequirement {
	...
	public EList<RequiredSecurityScheme> getSecuritySchemes() {
		if (securitySchemes == null) {
			securitySchemes = new EObjectContainmentEList<RequiredSecurityScheme>(RequiredSecurityScheme.class, this, OpenAPIProfilePackage.SECURITY_REQUIREMENT__SECURITY_SCHEMES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenAPIProfilePackage.SECURITY_REQUIREMENT__SECURITY_SCHEMES:
