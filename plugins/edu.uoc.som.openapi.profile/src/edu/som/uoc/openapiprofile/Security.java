 ...
 * </p>
 * <ul>
 *   <li>{@link edu.som.uoc.openapiprofile.Security#getSecurityRequirements <em>Security Requirements</em>}</li>
 *   <li>{@link edu.som.uoc.openapiprofile.Security#getBase_Model <em>Base Model</em>}</li>
 *   <li>{@link edu.som.uoc.openapiprofile.Security#getBase_Operation <em>Base Operation</em>}</li>
 * </ul>
 *
 * @see edu.som.uoc.openapiprofile.OpenapiprofilePackage#getSecurity()
 * @model
 * @generated
 */
public interface Security extends EObject {
	 ...
	 * @see edu.som.uoc.openapiprofile.OpenapiprofilePackage#getSecurity_SecurityRequirements()
	 ...
	 * @see edu.som.uoc.openapiprofile.OpenapiprofilePackage#getSecurity_Base_Model()
	 * @model ordered="false"
	 * @generated
	 */
	Model getBase_Model();
	...
	/**
	 * Sets the value of the '{@link edu.som.uoc.openapiprofile.Security#getBase_Model <em>Base Model</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.som.uoc.openapiprofile.OpenapiprofilePackage#getSecurity_Base_Operation()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.som.uoc.openapiprofile.Security#getBase_Operation <em>Base Operation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
